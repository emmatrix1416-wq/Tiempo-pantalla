(function(){
  ...
  safe('form', function(){
    ...
    form.addEventListener('submit', function(e){
      ...
      if (!nombre){
        aviso.textContent = 'Escribe tu nombre para agendar.';
        aviso.className = 'form-aviso error';
        form.nombre.focus();
        return;
      }
      aviso.className = 'form-aviso';
      aviso.textContent = 'Gracias, ' + nombre + '. En un sitio real esto llegaría a la clínica; aquí es solo una muestra.';
      form.reset();
    });
  });
})();
