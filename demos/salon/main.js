(function(){
  ...
  safe('form', function(){
    ...
    form.addEventListener('submit', function(e){
      ...
      if (!nombre){
        aviso.textContent = 'Escribe tu nombre para pedir la cita.';
        aviso.className = 'form-aviso error';
        form.nombre.focus();
        return;
      }
      aviso.className = 'form-aviso';
      aviso.textContent = 'Gracias, ' + nombre + '. En un sitio real esto llegaría al salón; aquí es solo una muestra.';
      form.reset();
    });
  });
